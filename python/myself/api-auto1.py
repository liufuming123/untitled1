...
def readExcel(file_path):
    ...
    '''
    try:
        book = xlrd.open_workbook('C:\\Users\\liufuming\\Desktop\\python\\api-case.xlsx')  # 打开excel
    except Exception, e:
...
def copy_excel(file_path, res_flags, request_urls, responses):
    ...
    new_book.save('%s_TestReport.xls' % time.strftime('%Y%m%d%H%M%S'))
...
if __name__ == '__main__':
    ...
    try:
        ...
        readExcel('C:\\Users\\liufuming\\Desktop\\python\\api-case.xlsx')
    print 'Done!'